...
describe("Math.clamp", function()
  test("", function()
    ...
    expect(Math.clamp(-2, -5, -1)).toEqual(-2)
    expect(Math.clamp(10, 100, 20)).toEqual(20)
  end)
end)
...
xdescribe("Math.mod", function()

end)

xdescribe("Math.polarToCart", function()

end)

xdescribe("Math.cartToPolar", function()
