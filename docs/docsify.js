(function () {
  ...
  ********************************************** */
  ...
  var Compiler = function Compiler(config, router) {
    ...
    // edited
    var renderer = this._initRenderer(config);
    var compile;
  ...
  Compiler.prototype._initRenderer = function _initRenderer (config) {
    ...
    origin.heading = renderer.heading = function (text, level) {
      ...
      // edited
      let customId;
      // if (renderer.config.useHeadingAnchors && str.match(/^<a.*<\/a>$/)) {
      //   customId = str.match(/[name|id]="(.+)"/)[1]
      //   console.log(customId)
      //   str = str.match(/>([^<>]+)</)[1]
      //   console.log(customId, str);
      // }
      ...
      // edited
      var slug = slugify(config.id || customId || str);
